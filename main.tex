...
composition, they lack the diversity and dynamic range of feature present in real samples \cite{bokulich2016mockrobiota}.
...
\subsection{Two-sample Titration Mixture Design}
...
\subsection*{Titration Series Validation and Correction}
...
\subsubsection*{Volumetric Mixing Validation}
...
\subsubsection*{Prokaryotic DNA Proportion Validation}
...
\subsubsection*{Correcting for deviations from mixture design}
...
\subsection{Assessment Dataset}
- experimental design (Fig. \ref{fig:countExperimentalDesign})
- sequence dataset - number of samples, reads per sample, ect. 
...
\subsection*{Count Table Assessment}
...
\paragraph{Bioinformatic Pipelines} QIIME, Mothur, and DADA2
...
\begin{equation}
  ...
  \label{eq:mixEq}
\end{equation}
\subsubsection*{Titration Series Validation}
