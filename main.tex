...
design, while the same phenomenon is significantly reduced in the QIIME and Mothur other pipelines. To see a summary of the titration-specific features which could and could not be explained by sampling, see supplementary table (??) `
