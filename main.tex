...
using qPCR (Fig. \ref{fig:titrationValidation}). To evaluate if the PRE and POST samples had the same
...
While the DADA2 count table had a higher prorportion of artifactual features the 
...
%% Not sure where to include the interpretion of the AFP and sparsity results - either here or the discussion
...
\ref{fig:assessmentFramework}B. \emph{Unmixed-} or
